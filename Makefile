...
pkgdatadir = $(datadir)/webcamtest
pkgincludedir = $(includedir)/webcamtest
pkglibdir = $(libdir)/webcamtest
pkglibexecdir = $(libexecdir)/webcamtest
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = webcamtest$(EXEEXT)
subdir = .
...
am__depfiles_remade = ./$(DEPDIR)/webcamtest.Po
am__mv = mv -f
...
am__v_CXXLD_1 = 
SOURCES = $(webcamtest_SOURCES)
DIST_SOURCES = $(webcamtest_SOURCES)
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"webcamtest\" -DVERSION=\"1.0\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
include ./$(DEPDIR)/webcamtest.Po # am--include-marker
